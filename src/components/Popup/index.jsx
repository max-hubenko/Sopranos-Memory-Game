    ...
    return (
      <div className="popup-div">
        <div className="inside-popup-div">
          ...
          <button id="start-button" onClick={() => handleClick(false)}>Start Game</button> </>
          : type == 'lose' ?
          <>
            <iframe src="https://giphy.com/embed/ZgULv0ulcWJ1PEe8PX" width="480" height="270"></iframe>
            <p className='Title'> You Lose!</p>
            <div id="buttons">
              <button id="start-button" onClick={() => handleClick(false)}>Restart Game</button>
              <button id="start-button" onClick={() => handleClick(true)}>Back to Start</button> 
            </div> 
          </>
          : <>
